...
public class SternaTestcase extends TestBase {
	...
	public void ValidateKeyValidationTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Key revalidation time", "6");
	...
	public void TerminalFillingTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Terminal filling time", "10");
	...
	public void KeyReturnTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Key return time", "10");
	...
	public void KeyboxDoorCloseTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Keybox door closetime", "10");
	...
	public void KeyboxDoorOpenTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Keybox door opentime", "10");
	...
	public void KeyboxHBDurationTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Keybox HB duration", "10");
	...
	public void KeyboxhooterEnabledField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterSelectValueToCurrentItem("Keybox hooter enabled", "Yes");
	...
	public void KeyboxTurnTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Keybox turn time", "10");
	...
	public void OTPCountField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("OTP count", "2");
	...
	public void RadiusField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Radius", "350");
	...
	public void SwipeInRepeatCountField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Swipe in", "2");
		pageFactoryManager.get().getConfigurationPage().clickSubmitToUpdate("Swipe in");
		pageFactoryManager.get().getConfigurationPage().clickAlertOKButton();
		pageFactoryManager.get().getDashBoardPage().clickOnLogout();
	}

	@Test(description = "Validate the Swipe Out Repeat Count Field", priority = 12)
	public void SwipeOutRepeatCountField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("Swipe out", "2");
	...
	public void VTSOffLineTimeField() {
		...
		pageFactoryManager.get().getConfigurationPage().enterNewValueToCurrentItem("VTS offline time", "10");
